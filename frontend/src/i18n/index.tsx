...
const messages: Record<FrontendLanguage, MessageDictionary> = {
  zh: {
    ...
    'common.taskNoLabel': '任务号',
    'common.goToTaskCenter': '前往任务中心',
    'common.afterSubmitShowTaskNo': '提交后会显示任务号。',
    'lang.zh': '中文',
    'lang.en': 'English',
    ...
    'scriptCreate.desc': '输入关键词后由 OpenAI 自动生成脚本。',
    'scriptCreate.toast.generated': '脚本生成成功',
    'scriptCreate.toast.created': '脚本任务已创建',
    'scriptCreate.form.title.label': '标题（可选）',
    'scriptCreate.form.title.placeholder': '例如：夏季新品短视频脚本',
    'scriptCreate.form.keywords.label': '关键词',
    'scriptCreate.form.keywords.required': '请输入关键词',
    'scriptCreate.form.keywords.placeholder': '例如：防晒、海边、年轻女性、活力、15秒',
    'scriptCreate.form.outputType.label': '输出类型',
    'scriptCreate.form.outputType.imageSet': '图集脚本',
    'scriptCreate.form.outputType.singleImage': '单图脚本',
    'scriptCreate.form.outputType.video': '视频脚本',
    'scriptCreate.form.style.label': '风格（可选）',
    'scriptCreate.form.style.placeholder': '例如：科技感 / 电影感 / 极简',
    'scriptCreate.form.sceneCount.label': '场景数',
    'scriptCreate.submit': '生成脚本',
    'scriptCreate.result.title': '生成结果',
    'scriptCreate.result.empty': '暂无脚本，提交后将在这里显示。',

    'imageCreate.desc': '对接 Stability API，提交后可在任务中心查看进度与结果。',
    'imageCreate.toast.submitted': '图片生成任务已提交',
    'imageCreate.form.prompt.label': '图片提示词',
    'imageCreate.form.prompt.required': '请输入提示词',
    'imageCreate.form.prompt.placeholder': '例如：A futuristic city skyline at sunset, cinematic lighting',
    'imageCreate.form.clarity.label': '清晰度',
    'imageCreate.form.style.label': '风格（可选）',
    'imageCreate.form.style.placeholder': '例如：photographic / digital-art / anime',
    'imageCreate.form.count.label': '生成数量',
    'imageCreate.submit': '提交图片任务',

    'videoCreate.desc': '对接 Runway API，视频任务会异步生成并在任务中心更新状态。',
    'videoCreate.toast.submitted': '视频生成任务已提交',
    'videoCreate.form.prompt.label': '视频提示词',
    'videoCreate.form.prompt.required': '请输入提示词',
    'videoCreate.form.prompt.placeholder':
      '例如：A startup product launch clip, energetic pacing, bold typography',
    'videoCreate.form.duration.label': '时长（秒）',
    'videoCreate.form.clarity.label': '清晰度',
    'videoCreate.form.style.label': '风格（可选）',
    'videoCreate.form.style.placeholder': '例如：cinematic / commercial / documentary',
    'videoCreate.submit': '提交视频任务',

    'adCreate.desc': '由 OpenAI 生成创意方案，再调用 Stability/Runway 生成广告素材。',
    'adCreate.toast.submitted': '广告任务已提交',
    'adCreate.form.adType.label': '广告类型',
    'adCreate.form.adType.image': '图像广告',
    'adCreate.form.adType.video': '视频广告',
    'adCreate.form.clarity.label': '清晰度',
    'adCreate.form.duration.label': '时长（秒）',
    'adCreate.form.productInfo.label': '产品信息',
    'adCreate.form.productInfo.required': '请输入产品信息',
    'adCreate.form.productInfo.placeholder': '例如：AI效率工具，主打团队协作与自动化流程',
    'adCreate.form.targetAudience.label': '目标受众',
    'adCreate.form.targetAudience.required': '请输入目标受众',
    'adCreate.form.targetAudience.placeholder': '例如：25-35 岁互联网产品经理',
    'adCreate.form.brandStyle.label': '品牌风格（可选）',
    'adCreate.form.brandStyle.placeholder': '例如：科技感、专业、可信赖',
    'adCreate.form.creativePlan.label': '创意方案（可选，留空则由系统自动生成）',
    'adCreate.form.creativePlan.placeholder': '可手动输入创意方案，或留空自动生成',
    'adCreate.submit': '提交广告任务',

    'tasks.desc.autoRefresh': '任务状态每 5 秒自动刷新，点击结果可直接查看生成内容。',
    'tasks.actions.refresh': '刷新',
    'tasks.filter.allTypes': '全部类型',
    'tasks.filter.type.script': '脚本',
    'tasks.filter.type.image': '图片',
    'tasks.filter.type.video': '视频',
    'tasks.filter.type.ad': '广告',
    'tasks.filter.allStatuses': '全部状态',
    'tasks.status.0': '排队中',
    'tasks.status.1': '处理中',
    'tasks.status.2': '已完成',
    'tasks.status.3': '失败',
    'tasks.table.taskNo': '任务号',
    'tasks.table.type': '类型',
    'tasks.table.status': '状态',
    'tasks.table.progress': '进度',
    'tasks.table.result': '结果',
    'tasks.table.view': '查看',
    'tasks.table.errorMessage': '错误信息',
    'tasks.table.createdAt': '创建时间',
  ...
  en: {
    ...
    'common.taskNoLabel': 'Task ID',
    'common.goToTaskCenter': 'Go to Task Center',
    'common.afterSubmitShowTaskNo': 'Task ID will appear after submission.',
    'lang.zh': '中文',
    'lang.en': 'English',
    ...
    'scriptCreate.desc': 'Enter keywords and generate scripts with OpenAI.',
    'scriptCreate.toast.generated': 'Script generated successfully',
    'scriptCreate.toast.created': 'Script task created',
    'scriptCreate.form.title.label': 'Title (optional)',
    'scriptCreate.form.title.placeholder': 'For example: Summer product short video script',
    'scriptCreate.form.keywords.label': 'Keywords',
    'scriptCreate.form.keywords.required': 'Please enter keywords',
    'scriptCreate.form.keywords.placeholder': 'For example: sunscreen, beach, young women, energetic, 15s',
    'scriptCreate.form.outputType.label': 'Output type',
    'scriptCreate.form.outputType.imageSet': 'Image set script',
    'scriptCreate.form.outputType.singleImage': 'Single image script',
    'scriptCreate.form.outputType.video': 'Video script',
    'scriptCreate.form.style.label': 'Style (optional)',
    'scriptCreate.form.style.placeholder': 'For example: tech / cinematic / minimal',
    'scriptCreate.form.sceneCount.label': 'Scene count',
    'scriptCreate.submit': 'Generate script',
    'scriptCreate.result.title': 'Generated result',
    'scriptCreate.result.empty': 'No script yet. It will appear here after submission.',

    'imageCreate.desc': 'Powered by Stability API. Check task progress and results in Task Center.',
    'imageCreate.toast.submitted': 'Image generation task submitted',
    'imageCreate.form.prompt.label': 'Image prompt',
    'imageCreate.form.prompt.required': 'Please enter a prompt',
    'imageCreate.form.prompt.placeholder': 'For example: A futuristic city skyline at sunset, cinematic lighting',
    'imageCreate.form.clarity.label': 'Resolution',
    'imageCreate.form.style.label': 'Style (optional)',
    'imageCreate.form.style.placeholder': 'For example: photographic / digital-art / anime',
    'imageCreate.form.count.label': 'Image count',
    'imageCreate.submit': 'Submit image task',

    'videoCreate.desc': 'Powered by Runway API. Video tasks run asynchronously and update in Task Center.',
    'videoCreate.toast.submitted': 'Video generation task submitted',
    'videoCreate.form.prompt.label': 'Video prompt',
    'videoCreate.form.prompt.required': 'Please enter a prompt',
    'videoCreate.form.prompt.placeholder':
      'For example: A startup product launch clip, energetic pacing, bold typography',
    'videoCreate.form.duration.label': 'Duration (seconds)',
    'videoCreate.form.clarity.label': 'Resolution',
    'videoCreate.form.style.label': 'Style (optional)',
    'videoCreate.form.style.placeholder': 'For example: cinematic / commercial / documentary',
    'videoCreate.submit': 'Submit video task',

    'adCreate.desc':
      'Generate creative direction with OpenAI, then produce ad assets via Stability and Runway.',
    'adCreate.toast.submitted': 'Ad task submitted',
    'adCreate.form.adType.label': 'Ad type',
    'adCreate.form.adType.image': 'Image ad',
    'adCreate.form.adType.video': 'Video ad',
    'adCreate.form.clarity.label': 'Resolution',
    'adCreate.form.duration.label': 'Duration (seconds)',
    'adCreate.form.productInfo.label': 'Product information',
    'adCreate.form.productInfo.required': 'Please enter product information',
    'adCreate.form.productInfo.placeholder':
      'For example: AI productivity tool focused on team collaboration and automation',
    'adCreate.form.targetAudience.label': 'Target audience',
    'adCreate.form.targetAudience.required': 'Please enter target audience',
    'adCreate.form.targetAudience.placeholder': 'For example: Internet product managers aged 25-35',
    'adCreate.form.brandStyle.label': 'Brand style (optional)',
    'adCreate.form.brandStyle.placeholder': 'For example: tech-forward, professional, trustworthy',
    'adCreate.form.creativePlan.label':
      'Creative plan (optional, leave blank to auto-generate)',
    'adCreate.form.creativePlan.placeholder':
      'You can enter a creative plan manually, or leave blank for auto-generation',
    'adCreate.submit': 'Submit ad task',

    'tasks.desc.autoRefresh':
      'Task status auto-refreshes every 5 seconds. Click the result link to open generated content.',
    'tasks.actions.refresh': 'Refresh',
    'tasks.filter.allTypes': 'All types',
    'tasks.filter.type.script': 'Script',
    'tasks.filter.type.image': 'Image',
    'tasks.filter.type.video': 'Video',
    'tasks.filter.type.ad': 'Ad',
    'tasks.filter.allStatuses': 'All statuses',
    'tasks.status.0': 'Queued',
    'tasks.status.1': 'Processing',
    'tasks.status.2': 'Completed',
    'tasks.status.3': 'Failed',
    'tasks.table.taskNo': 'Task ID',
    'tasks.table.type': 'Type',
    'tasks.table.status': 'Status',
    'tasks.table.progress': 'Progress',
    'tasks.table.result': 'Result',
    'tasks.table.view': 'View',
    'tasks.table.errorMessage': 'Error message',
    'tasks.table.createdAt': 'Created at',
